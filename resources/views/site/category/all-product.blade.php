                                    ...
                                    @foreach($products as $product)
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-3 mt-2 category-item">
                                            <div class="ProductList-item">
                                                <a href="{{route('new.detail', $product->id)}}" class="a-decoration">
                                                    <div class="Product-list-item a-decoration">
                                                        <div class="Product-list-item-img mb-2">
                                                            ...
                                                            <img class="Product-list-item-img-hover"
                                                                 src="https://via.placeholder.com/1000x1000.png/#FFCC66?text=1"
                                                                 alt="">
                                                        </div>
                                                ...
                                                <div class="QuickView w-100 text-center" data-bs-toggle="modal"
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade modal-quickview" id="modal-product-1"
                                                     tabindex="-1" aria-labelledby="exampleModalLabel"
                                                     aria-hidden="true">
                                                    <div type="button" class="btn-close btn-close-quickview"
                                                                            ...
                                                                            <div class="col-4">
                                                                                <div class="quickview-right">
                                                                                    <div class="product-quickview-name">
                                                                                        <h1>
                                                                                            <a href="{{route('new.detail', $product->id)}}">
                                                                                                {{$product->name}}</a>
                                                                                        </h1>
                                                                                    </div>
                                                                                    <div
                                                                                        class="product-quickview-price">
                                                                                        <h5>$ {{$product->price}}</h5>
                                                                                    </div>
                                                                                    <div class="product-quickview-info">
                                                                                        A sleeping fox nestles into the
                                                                                        mug den, among 3 white
                                                                                        wildflowers. Aqua glaze breaks
                                                                                        over the rounded design and
                                                                                        dappled texture. Yellow stars
                                                                                        and fireflies dot the skyline.
                                                                                        22k ...
                                                                                    </div>
                                                                                    <div
                                                                                        class="product-quickview-properti">

                                                                                        <div class="radio-detail">
                                                                                            <div
                                                                                                class="radio-detail-label">
                                                                                                <div
                                                                                                    class="radio-detail-label-size">
                                                                                                    <label
                                                                                                ...
                                                                                                <div
                                                                                                    class="radio-detai-label-color">
                                                                                                    <label
                                                                                                        class="radio-color-title"
                                                                                                        class="radio-size-title font-comfortaa"
                                                                                                        for="">COLOR:</label>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="radio-detail-input">
                                                                                                <div
                                                                                                    class="radio-detail-input-size">
                                                                                                    <input type="radio"
                                                                                                           id="radio1"
                                                                                                           name="size-detail"
                                                                                                           value="all"
                                                                                                ...
                                                                                                <div
                                                                                                    class="radio-detail-input-color">
                                                                                                    <label
                                                                                                        class="text-bold label-product"
                                                                                    ...
                                                                                    <div
                                                                                        class="product-quickview-addcart">
                                                                                        <a href="#">Add To Cart</a>
                                                                                    </div>
                                                                                    <div
                                                                                        class="product-quickview-linkfull">
                                                                                        <a href="{{route('new.detail', 2)}}">View
                                                                                            Full Item</a>
                                                                                    </div>
                                                                                </div>
