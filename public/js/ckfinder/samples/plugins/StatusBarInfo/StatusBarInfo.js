...
CKFinder.define( [ 'underscore', 'backbone', 'marionette', 'doT' ], function( _, Backbone, Marionette, doT ) {
	...
	return {
		init: function( finder ) {
			...
			// Wait for the 'pages:create:Main' event to attach the status bar
			finder.on( 'pages:create:Main', function() {
				// Create a status bar named 'MyStatusBar' for the 'Main' pages which contains the files pane.
