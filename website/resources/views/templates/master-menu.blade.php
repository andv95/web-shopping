...
<body>
	...
	<div class="container menu-navbar">
		...
		<header class="bp-header cf">
			<div class="dummy-logo menu-hide">
				<div class="dummy-icon foodicon foodicon--coconut"></div>
				<h2 class="dummy-heading">Web Hoang</h2>
			</div>
			<div class="bp-header__main">
				<nav class="bp-nav">
                    ...
                    <a class="bp-nav__item bp-icon bp-icon--prev" href="" data-info="Ngôn ngữ">
                        <span>Ngôn ngữ</span>
                    </a>
					<a class="bp-nav__item bp-icon bp-icon--drop" href="" data-info="Người dùng">
                        <span>Người dùng</span>
                    </a>
					<a class="bp-nav__item bp-icon bp-icon--archive" href="" data-info="Giỏ hàng">
                        <span>Giỏ hàng</span>
                    </a>
				</nav>
			</div>
		...
		<nav id="ml-menu" class="menu menu-hide">
			<button class="action action--close" aria-label="Close Menu">
                <span class="icon icon--cross"></span>
            </button>
            <span class="close js-close-menu text-left">
        ...
        <!-- Menu Button Hide -->
        <div class="clickable-mainmenu-btn" data-toggle="" data-target="">
