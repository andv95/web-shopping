                            ...
                            <div class="header__item">
                                <div class="left__item">
                                    ...
                                    <div class="title__item">
                                        ...
                                        <div class="left-item__properti">Phân loại hàng: <span class="properti-first">Red color</span>,
                ...
                @else
                    ...
                    <div class="form-not-user-wrap">
                        ...
                        <div class="mt-4 form-input-style">
                            <label id="label-phone" class="form-input-style-label opacity-0" for="phone">Phone</label>
                            <input required id="phone" name="phone" class="block w-100 form-input-style-input" type="number"
                                   placeholder="Phone">
                        </div>
                        ...
                        <div class="mt-4 form-input-style">
                            <label id="label-address" class="form-input-style-label opacity-0" for="address">Address</label>
                            <input required id="address" name="address" class="block w-100 form-input-style-input" type="text"
                                   placeholder="Address">
                        </div>

                        <div class="mt-4 form-input-style">
                            <label id="label-aparment" class="form-input-style-label opacity-0" for="aparment">Aparment, suite, etc (optional)</label>
                            <input required id="aparment" class="block form-input-style-input w-100" type="text" name="aparment"
